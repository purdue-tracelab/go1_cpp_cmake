...
def plot_state_data(csv_file, absolute=False):
    ...
    ## Commented out since we're using joint space swing leg PD instead of Cartesian space
    # plt.subplot(3, 2, 4)
    # shade_by_phase(plt.subplot(3, 2, 4), time, swing_phase)
    ...
    plt.axhline(y=0.863, color='k', linestyle='--')
    plt.axhline(y=-0.863, color='k', linestyle='--')
    ...
    plt.axhline(y=4.501, color='k', linestyle='--')
    plt.axhline(y=-0.686, color='k', linestyle='--')
    ...
    plt.axhline(y=-0.888, color='k', linestyle='--')
    plt.axhline(y=-2.818, color='k', linestyle='--')
    ...
    plt.axhline(y=23.7, color='k', linestyle='--')
    plt.axhline(y=-23.7, color='k', linestyle='--')
    ...
    plt.axhline(y=35.55, color='k', linestyle='--')
    plt.axhline(y=-35.55, color='k', linestyle='--')
    ...
    plt.axhline(y=130.0, color='k', linestyle='--') # make sure to match with UNITREE_SDK_CONTACT_THRESH in go1Params.h
    plt.xlabel("Time (s)")
